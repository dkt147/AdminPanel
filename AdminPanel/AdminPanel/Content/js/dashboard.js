  ...
  if($('#flotChart1').length) {
    $.plot('#flotChart1', [{
      ...
      yaxis: {
        ...
        ticks: [[0, '-100% (Bear)'], [10, '-75%'], [20, '-50%'], [30, '-25%'], [40, '0%'], [50, '+25%'],[60, '+50%'], [70, '+75%'], [80, '+100% (Bull)']],
      ...
      xaxis: {
        ...
        ticks: [[0, ' '], [20, '1 Jan'], [40, '2 Jan'], [60, '3 Jan'], [80, '4 Jan'], [100, '5 Jan'], [120, '6 Jan'], [140, '7 Jan']],
        tickColor: gridLineColor,      
        font: {
          size: 13,
          color: colors.muted
  ...
  if($('#flotChart2').length) {
    $.plot('#flotChart2', [{
      ...
      yaxis: {
        show: true,
        color: 'rgba(0,0,0,0.06)',
        ticks: [[0, ''], [15, '-1'], [30, '-0.5'], [45, '0'], [60, '+0.5'], [75, '+1']],
        tickColor: gridLineColor,
        min: 0,
        max: 80,
        font: {
